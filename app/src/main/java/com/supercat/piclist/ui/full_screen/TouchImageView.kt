...
/** Forked from https://github.com/MikeOrtiz/TouchImageView */
...
open class TouchImageView @JvmOverloads constructor(
    ...
    override fun setScaleType(type: ScaleType) {
        if (type == ScaleType.MATRIX) {
            ...
            if (onDrawReady) {
                ...
                // and the com.supercat.piclist.ui.full_screen.TouchImageView should be updated with the new scaleType.
                setZoom(this)
            }
        }
    }
    ...
    /**
     * Set zoom parameters equal to another com.supercat.piclist.ui.full_screen.TouchImageView. Including scale, position,
     * and ScaleType.
     */
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        // changes. For example, if the com.supercat.piclist.ui.full_screen.TouchImageView is inside a ConstraintLayout, onMeasure may
        // be called with:
        ...
        // to class members, such as fitting the image into the new shape of the com.supercat.piclist.ui.full_screen.TouchImageView,
     ...
     * 1. When the com.supercat.piclist.ui.full_screen.TouchImageView is first loaded (onMeasure).
    ...
    private inner class PrivateOnTouchListener : OnTouchListener {
        ...
        override fun onTouch(v: View, event: MotionEvent): Boolean {
            ...
            // OnTouchImageViewListener is set: com.supercat.piclist.ui.full_screen.TouchImageView dragged by user.
    ...
    private inner class ScaleListener : SimpleOnScaleGestureListener() {
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            // OnTouchImageViewListener is set: com.supercat.piclist.ui.full_screen.TouchImageView pinch zoomed by user.
            touchImageViewListener?.onMove()
            return true
        }
    ...
    private inner class Fling(velocityX: Int, velocityY: Int) : Runnable {
        ...
        override fun run() {
            ...
            // OnTouchImageViewListener is set: com.supercat.piclist.ui.full_screen.TouchImageView listener has been flung by user.
